...
class ProcessContent:
    global global_weight, global_errors, list_of_tags, red_flag_sentence_report, input_sentence, red_flag_count
    red_flag_count += 1
    tokens = ""
    tagged_tokens = ""
    bow = []
    ...
    def conceptAPI(self):
        global tokens, global_weight, global_errors, input_sentence
        ...
        if len(ProcessContent.list_of_weights) > 0:
            ...
            for term in tokens:
                ...
                term_weight_score[term] = sum(weights_score_of_rest_of_the_terms)
...
# t = ProcessContent()
# print(t.run('Pen will be delivered to you.'))
